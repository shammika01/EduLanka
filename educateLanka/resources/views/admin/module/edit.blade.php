...
@section('content_title', 'Edit Module')
@section('breadcrumb', '')
    ...
    <div class="container">
        <form method="post" action="">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" class="form-control" id="name" value="{{ $getRecord->name }}" name="name"
                    required>
            </div>

            <div class="form-group mb-4">
                <label for="name">Course ID</label>
                <input type="text" class="form-control" id="course_id" value="{{ $getRecord->course_id }}"
                    name="name" required>
            </div>
            <div class="form-group mb-4">
                <label>Type</label>
                <select class="form-control" name="type" required>
                    ...
                    <option {{ $getRecord->type == 'Lecture' ? 'selected' : '' }} value="Lecture">Lecture</option>
                    <option {{ $getRecord->type == 'Practicals' ? 'selected' : '' }}value="Practical">Practical</option>
                </select>
            </div>
            <div class="form-group mb-4">
                <label>Status</label>
