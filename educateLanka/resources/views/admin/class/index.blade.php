...
@section('content_title', 'Course Table')
@section('breadcrumb', '')
    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link active" href="{{ route('admin.class.index') }}" data-bs-toggle="collapse"
...
@section('content')
    <a href="{{ url('/admin/class/add') }}" class="btn btn-primary">Add</a>
    <div class="container">
        <table class="table">
            <thead>
                <tr>
                ...
                @foreach ($getRecord as $value)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ url('/admin/class/delete', $value->id) }}" class="btn btn-primary">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
