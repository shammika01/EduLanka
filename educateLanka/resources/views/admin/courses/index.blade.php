...
@section('content_title', 'Course Allocation')
@section('breadcrumb', 'Allocate Course - Student')
...
@section('content')
    <a href="{{ route('admin.classuser.add') }}" class="btn btn-primary">Add</a>
            ...
            <tbody>
                @foreach ($classusers as $value)
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('admin.courseuser.destroy', $value->id) }}"
    ...
    <a href="{{ route('admin.classteacher.add') }}" class="btn btn-primary">Add</a>
    <div class="container">
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @forelse($classteachers as $value)
                    <tr>
                        <td>{{ $value->id }}</td>
                        <td>{{ $value->teacher_id }}</td>

                        <td>
                            <a href="{{ route('admin.classteacher.add') }}" class="btn btn-primary">Update</a>
