...
@section('content_title', 'Class/Modules')
@section('breadcrumb', '')
...
@section('content')
    <a href="{{ url('/admin/cls_module/add') }}" class="btn btn-primary">Add</a>
    <div class="container">
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($getRecord as $value)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('/admin/cls_module/edit', $value->id) }}" class="btn btn-primary">Edit</a>
                            <a href="{{ url('/admin/cls_module/delete', $value->id) }}" class="btn btn-primary">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
